...
# entries that occupy two slots in the constant pool
WIDE_ENTRIES = (CONSTANT_Long, CONSTANT_Double)

# ---- Class/field/method access flags (subset we care about) ----
ACC_PUBLIC = 0x0001
ACC_PRIVATE = 0x0002
...
# ---- Primitive array type codes for `newarray` ----
T_BOOLEAN = 4
T_CHAR = 5
T_FLOAT = 6
T_DOUBLE = 7
...
ARRAY_TYPE_NAMES = {
    T_BOOLEAN: "boolean", T_CHAR: "char", T_FLOAT: "float", T_DOUBLE: "double",
    T_BYTE: "byte", T_SHORT: "short", T_INT: "int", T_LONG: "long",
}

# ---- Opcode mnemonics (only the ones the interpreter implements are listed;
# unknown/unsupported opcodes raise a clear error at runtime rather than
...
OPCODES = {
    ...
    0x80: "ior", 0x81: "lor", 0x82: "ixor", 0x83: "lxor", 0x84: "iinc",
